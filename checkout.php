...
if($_POST['kirim'] == "KIRIM"){
	...
	//Depo Pakai Data Lama (CHECKING PAKAI DC)
	...
	//Depo Pakai Data Baru
	$arrDepo = array("DC DENPASAR", "DC KLUNGKUNG", "DC KARANGASEM", "DC GIANYAR");
	if (in_array($depo_replace, $arrDepo)){
		$product = "ELOAD-16";
	}
	if($depo_replace == "DC LOMBOK"){
		$product = "ELOAD-20";
	}
          ...
          <div class="banner-box">
            <div class="media">
              ...
              <div class="media-body">
                <span class="font-sm">Order ID: <?=$idsales?> <?= $data1?></span>
