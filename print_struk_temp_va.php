...
*/
$sql = "select l.id, l.date_order, DATE_ADD(now(), interval 2 hour) as limittime, l.id_product, l.no_faktur, l.detail_notes, l.id_customer, p.name_product, l.id_customer, l.qty, l.unit_price, l.total, l.fee, l.totalpay, l.via from validasi_sales_invoice l
left join products p on (l.id_product = p.id_product) where l.idsalesman = '$idsales' and l.no_faktur='$nofaktur'";
//echo $sql;
$msq = mysql_query($sql);
...
<table class="autosize" width="100%">
  <tr>
	...
	<tr>
		<td colspan="3"><u>Nomor VA Mandiri anda</u></td>
  </tr>

	<tr>
		<td colspan="3"><?=$nova?></td>
  </tr>
	<tr>
