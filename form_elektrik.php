  ...
  $view_s = "<form method='post'>
            <div class='row'>
				<div class='col-12'>
					...
					<input id='nomorhpc' name='nomorhpc' type='number' style='font-size: 14pt;' class='form-control' autocomplete='Off' onkeyup='autoCompletehlr();' placeholder='Masukkan Nomor HP' required autofocus>
				</div>
			</div>
					...
					<div class="">
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<h4 class="title-color" style="font-size:14pt"><strong>BELI PULSA</strong></h4>
							</div>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<?php 
	                            	echo $view_s;
