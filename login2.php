						...
						if($curr_pin == $passEnkrip){
							...
							if($passEnkrip == 123456){
								...
								if($jumcek > 2){
									...
									$sql ="insert into otp set username = '$username', tanggal=now(), no_otp = $otp, status=0";
									if(mysql_query($sql)){
														...
														"hsm": {
															...
															"components": [{
																	...
																	"parameters": [{
																		"type": "image",
																		"image": {
																			"url": "https://nexa.id/wp-content/uploads/2023/04/MOBITELx.png"
																		}
																	}]
																},
														{
