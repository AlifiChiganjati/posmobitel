...
if($_SESSION['ROLE'] == "CESA" or $_SESSION['ROLE'] == "JBL SF"){
	$sql = "select * from menu_group where nama_group not in  ('SMARTFREN','JBL') and status=1";
}else{
	$sql = "select * from menu_group where nama_group not in  ('SMARTFREN SF','JBL SF') and status=1";
}
