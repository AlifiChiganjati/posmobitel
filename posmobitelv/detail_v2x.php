...
<?php  
	...
	while($data=mysql_fetch_object($qry)){
		...
		$color = "<span class='content-color font-xs'><small>".$colors."</small></span><br>";
		$product_name = $data->product_size;
		if($diskon4 != 0){
			$harga1 = $harga;
			$harga2 = number_format($data->unit_price - $diskon4);
			$tampil_harga1 = "<span class='content-color font-xs' style='text-decoration: line-through;'><small>Rp$harga1</small></span><br>";
			$tampil_harga2 = "<span class='content-color font-xs'><small>DTP: Rp$harga2</small></span><br>";
		}else{
			$harga1 = $harga;
			$tampil_harga2 = "";
			$tampil_harga1 = "<span class='content-color font-xs'><small>DTP: Rp$harga1</small></span><br>";
		}
		$harga_srp = $data->srp_price;
		$tampil_srp = "";
		if($harga_srp > 0){
			$tampil_srp = "<span class='content-color font-xs'><small>SRP: Rp".number_format($harga_srp)."</small></span><br>";
		}
		$image=$data->image;
		if($image == ""){
			$src = "menu_icons/1.png";
		...
		if($cek_im == 0){
			$btn_qty = "<input type='hidden' value='0' min='0' max='100' name='qty[]'>
							<small>Out of stock</small>";
		}else{
			$btn_qty = "<div class='plus-minus'>
							<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-minus sub'><line x1='5' y1='12' x2='19' y2='12'></line></svg>
						
							<input type='number' value='$qty_in_chart' min='0' max='100' name='qty[]' style='width:100;background-color:yellow;'>
							<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-plus add'><line x1='12' y1='5' x2='12' y2='19'></line><line x1='5' y1='12' x2='19' y2='12'></line></svg>
						</div>";
		}
		echo "<div class='row mx-1 mt-2 rounded p-1'>
				<div class='col-2 align-self-center'>
					<img src='$src' alt='offer' width='100%' height='50'>
				</div>
				<div class='col-10 '>
					<input type='hidden' value='$data->id_product' name='idp[]'>
					<div class='col-12'><span class='font-xs'><small'> $product_name</small></span></div>
					<div class='col-12'>
						<div class='row'>
							<div class='col-sx-12 col-8'>
								$color
								$tampil_harga1 $tampil_harga2 $tampil_srp
							</div>
							<div class='col-sx-12 col-4 text-center'>
