				...
				if($arrsales){
					...
					if($idcustomer && $saldo && $keterangan && $pcs) {
						...
						detail_notes, description, data1, data2, cluster, reff, transdate, no_faktur, opr, tipe, jenis)
						 values (now(), '$idsales', '$tipe', $pcs, '$svesaldo', 'GUDANG ELEKTRIK - HQ', '$gudang', '$idcustomer', '$keterangan $sp $pcs PCS $idsales $idcustomer',
...
<main class="main-wrap cart-page mb-xxl">
   ...
   <!-- Form Section Start -->
      <form class="custom-form" method="post">
        ...
        <div class="input-box">
          <i class="iconly-Plus icli"></i>
          <input class="form-control" type="text" id="pcs" name="pcs" placeholder="Jml Pcs x1500" autocomplete="Off" onkeyup="findTotal('settotal')">
        </div>
