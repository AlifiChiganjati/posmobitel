  ...
  <!-- Header Start -->
    ...
    <aside class="header-sidebar">
	  ...
	  <br><br>
        ...
        <div id="mapsdata" style="display:none">
            <div id="salesid"> <?=$user?> </div>
            <div id="salesname"> <?=$name?> </div>
            <div id="salescluster"> <?=$role?> </div>
            <div id="salesdepartment"> <?=$city?> </div>
        </div>
        ...
        <nav class="navigation">
      	...
      	<li>
        	<a href="check_in_location.php" class="nav-link title-color font-sm">
            <i class="iconly-Location icli"></i>
            <span>Check-In</span>
          </a>
          <a class="arrow" href="check_in_location.php"><i data-feather="chevron-right"></i></a>
        </li>
        ...
        ?>
	        <li>
	        	<a href="sales_maps.php" class="nav-link title-color font-sm">
	            <i class="iconly-Discovery icli"></i>
	            <span>Maps</span>
	          </a>
	          <a class="arrow" href="sales_maps.php"><i data-feather="chevron-right"></i></a>
	        </li>
