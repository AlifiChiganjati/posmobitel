	...
	if($jums == 0){
		...
		while($data=mysql_fetch_object($qry)){
			...
			echo  "<div class='row border rounded g-0 mb-1 py-1'>
					<div class='col-2 text-center'>
						<a href='detail.php?prd=$base&merk=$merk&cat=$cat'><img src='$src' alt='offer' width='90%'></a>
					</div>
					<div class='col-10'>
						<div class='row'>
		...
		echo "<form method='post' class='custom-form'>
				...
				<div class='input-box'>
				 ...
				 <div class='input-box'>
					<input type='text' class='form-control mt-1' required='' placeholder='ID Pelanggan' id='idcustomer' name='idcustomer' onkeyup='autoCompletecustomer_cesa();' autocomplete='Off'></input>	
