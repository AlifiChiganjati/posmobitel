  ...
  while ($rs = mysql_fetch_object($sql)){
	...
	$res .= "<div class='offer-box'>
                  <div class='media'>
                    ...
                    <a href='detail_fisik.php?idproduk=$rs->id_product'><span class='badges font-theme'>".number_format($rs->qty)."</span></a>
                  </div>
                </div>";
