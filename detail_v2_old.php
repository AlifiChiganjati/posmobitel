...
<?php  
	...
	while($data=mysql_fetch_object($qry)){
		...
		$color = ucwords(strtolower($data->product_color));
		if($diskon4 != 0){
			$harga1 = $harga;
		...
		echo "<div class='product-list media'>
				...
				<div class='media-body'>
				  <a href='#' class='font-sm'> <small>$data->product_size </small> </a>
				  <span class='content-color font-sm'><small>$color</small></span>
