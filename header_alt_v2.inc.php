...
<html lang="en">
  ...
  $role = $_SESSION['ROLE'];
  if($jum_cart > 0){
	$badge = "<span class='bagde bg-secondary rounded text-white px-1 pb-1'><small>$jum_cart</small></span>";
  }
  ?>
  <!-- Header Start -->
    <header class="header sticky-top bg-white">
      ...
      <div class="">
		<?=$badge?>
        <a href="cart_v2.php?merk=<?=$merk?>&cat=<?=$cat?>"> <img class="avatar" src="iconm/cart.png" alt="avatar" style="width:25px;"></a>
      </div>
    </header>
