...
function autoCompletecustomer_imei_jbl(field){
	getAjax();
	input = document.getElementById('idcustomer').value;
	if (input == ""){
		document.getElementById("hasilcustomer").innerHTML = "";
	}else{
		ajaxRequest.open("GET","getdata_imei_jbl.php?tipe=customer&term="+input);
		ajaxRequest.onreadystatechange = function()	{ document.getElementById("hasilcustomer").innerHTML = ajaxRequest.responseText;}
		ajaxRequest.send(null);
	}
}

function auto_product_jbl(field){
	getAjax();
	input = document.getElementById('no_imei').value;
	console.log(input);
	if (input == ""){
		document.getElementById("hasilproduct").innerHTML = "";
	}else{
		ajaxRequest.open("GET","getdata_imei_jbl.php?tipe=product&term="+input);
		ajaxRequest.onreadystatechange = function()	{ document.getElementById("hasilproduct").innerHTML = ajaxRequest.responseText;}
		ajaxRequest.send(null);
	}
}

function autoInsert_product_jbl(nama){
	var arr = nama;
	data = arr.split("#");
	document.getElementById("no_imei").value = data[0];
	document.getElementById("product_name").value = data[1];
	document.getElementById("hasilproduct").innerHTML = "";
}
...
function autoInsertcustomer_imei_jbl(nama){
	var arr = nama;
	data = arr.split("#");
	document.getElementById("idcustomer").value = data[0];
	document.getElementById("namacustomer").value = data[1];
