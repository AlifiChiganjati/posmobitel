		...
		$diskon4 = $data->discount_4;
  		...
  		echo "<div class='col-6 mb-1'>
              <div class='product-card'>
                <div class='img-wrap text-center' style='height:7rem'>
                  <a href='$link' tabindex='-1'><img src='$src' class='' alt='product' height='90rem' width='100%'> </a>
                </div>
                <div class='content-wrap'>
                  <a href='$link' class='font-sm title-color' tabindex='-1'><small>$data->product_name</small></a>
