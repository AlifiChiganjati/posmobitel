...
$prd = $_GET['operator'];
$title = $tipe ;
$back_button = "form_emoney.php?tipe=$tipe";
...
if(isset($_POST['next1'])){
  ...
  if($jum_no < 10){
    ...
    if($nomor){
		...
		$reff = "ELC-".$reffx . $rand;
		$sql ="insert into elektrik_temp set tipe='PULSA REGULAR', nomor='$nomor', kode='$produk', keterangan='$ket', harga='$hrg', harga_vendor='$hrg_modal', 
...
if($jum == 0){
  $view_s = "<form method='post'>
            <div class='row'>
				<div class='col-12'>
					<div class='content-color' style='font-size:11pt;'>Nomor / ID:</div>
					<input type='hidden' name='layanan1' id='layanan1' value='$prd'>
					<input id='nomorhpc' name='nomorhpc' type='number' style='font-size: 14pt;' class='form-control' autocomplete='Off' onkeyup='autoCompletemoney();' placeholder='Masukkan Nomor / ID' required autofocus>
				</div>
			</div>
					...
					<div class="">
						<div class="row">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<h4 class="title-color" style="font-size:14pt"><strong>TOPUP <?=$tipe?> <?=$prd?></strong></h4>
							</div>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<?php 
	                            	echo $view_s;
