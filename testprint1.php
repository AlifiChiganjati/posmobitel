...
$det = "QkRSLUZLVC9DU0EwODg3OS0wNTIwMjMtMTExODE0NTY=";
...
while($re = mysql_fetch_object($msq)){
	...
	$totalxbyar = number_format($totalbayar);
	$totalxs += $re->total;
...
<table class="autosize">
  <tr>
	...
	<tr>
		<td width="33%">ID Outlet</td><td width="2%" align="center">:</td><td colspan="2" align="left" width="65%"><?=$outlet?></td>
  </tr>
	<tr>
		<td width="33%">No HP</td><td width="2%" align="center">:</td><td colspan="2" align="left" width="65%"><?=$cust?></td>
  </tr>
	<tr>
	...
	<tr>
		...
		<a href="#" onClick="location.href='testprint1.php?cmd=print2web';">PRINT</a> 
		</td>
  </tr>
</table>
</body>
